...
1. **อัปเดต** — มีถามยืนยัน อัปเดต manager/core แล้วรีสตาร์ท VPS
2. **ถอนการติดตั้ง** — มีถามยืนยัน ลบ manager, service และไฟล์ระบบ แล้วรีสตาร์ท VPS
3. **จัดการ user** — เพิ่ม ลบ แสดงรายการ ต่ออายุ และบล็อก/ปลดบล็อกบัญชี
4. **ติดตั้งระบบ UDP** — มีถามยืนยัน ดาวน์โหลด core สร้าง service แล้วรีสตาร์ท VPS
5. **เปิดพอร์ตทุกพอร์ต** — มีคำเตือนและถามยืนยัน ปิด UFW แล้วรีสตาร์ท VPS; ไม่แนะนำบนเครื่อง production
...
ดูรายละเอียด source และเอกสารทางการของเครื่องมือทั้งหมดที่ [SOURCES.md](SOURCES.md)
